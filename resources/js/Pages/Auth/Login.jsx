        ...
        <>
            ...
            <div style={{
                ...
                <div style={{
                    ...
                    <div style={{ width: '100%' }}>
                        <h2 style={{ color: '#333333', fontSize: '24px', fontWeight: 700, marginBottom: '6px' }}>Sign in</h2>
                        <p style={{ color: '#333333', fontSize: '14px', marginBottom: '28px' }}>
                        ...
                        <form onSubmit={submit}>
                            <div style={{ marginBottom: '16px' }}>
                                <label style={{ display: 'block', fontSize: '13px', fontWeight: 500, color: '#333333', marginBottom: '6px' }}>
                                    Email Address
                                </label>
                                <input
                                    type="email"
                                    ...
                                    style={{
                                        ...
                                        border: `1px solid ${errors.email ? '#F37021' : '#d1d5db'}`,
                                        borderRadius: '6px', fontSize: '14px', color: '#333333', outline: 'none',
                                        boxSizing: 'border-box', background: '#fff',
                                    }}
                                    onFocus={e => e.target.style.borderColor = '#1B365D'}
                                    onBlur={e => e.target.style.borderColor = errors.email ? '#F37021' : '#d1d5db'}
                                />
                                {errors.email && <p style={{ color: '#F37021', fontSize: '12px', margin: '4px 0 0' }}>{errors.email}</p>}
                            </div>

                            <div style={{ marginBottom: '20px' }}>
                                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '6px' }}>
                                    <label style={{ fontSize: '13px', fontWeight: 500, color: '#333333' }}>Password</label>
                                    {canResetPassword && (
                                        <Link href={route('password.request')} style={{ color: '#F37021', fontSize: '12px', textDecoration: 'none' }}>Forgot password?</Link>
                                    )}
                                </div>
                                <input
                                    type="password"
                                    ...
                                    style={{
                                        width: '100%', padding: '10px 12px',
                                        border: `1px solid ${errors.password ? '#F37021' : '#d1d5db'}`,
                                        borderRadius: '6px', fontSize: '14px', color: '#333333', outline: 'none',
                                        boxSizing: 'border-box', background: '#fff',
                                    }}
                                    onFocus={e => e.target.style.borderColor = '#1B365D'}
                                    onBlur={e => e.target.style.borderColor = errors.password ? '#F37021' : '#d1d5db'}
                                />
                                {errors.password && <p style={{ color: '#F37021', fontSize: '12px', margin: '4px 0 0' }}>{errors.password}</p>}
                            </div>
                            ...
                            <button
                                ...
                                style={{
                                    ...
                                    background: processing ? '#93c5fd' : '#F37021',
                                    color: '#fff', border: 'none', borderRadius: '6px',
                                    fontSize: '14px', fontWeight: 600, cursor: processing ? 'not-allowed' : 'pointer',
                                    transition: 'background 0.15s',
                                }}
                                onMouseEnter={e => { if (!processing) e.target.style.background = '#F37021'; }}
                                onMouseLeave={e => { if (!processing) e.target.style.background = '#F37021'; }}
                            >
                                {processing ? 'Signing in...' : 'Sign In'}
                            </button>
                        </form>

                        <p style={{ textAlign: 'center', color: '#333333', fontSize: '13px', marginTop: '20px' }}>
                            Don't have an account?{' '}
                            <Link href={route('register')} style={{ color: '#F37021', textDecoration: 'none', fontWeight: 600 }}>Apply for Admission</Link>
                        </p>
                    </div>
                </div>
            </div>
