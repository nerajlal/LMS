...
<div class="relative overflow-hidden pt-10 pb-20">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        <div>
            <div class="inline-flex items-center gap-2 px-3 py-1 bg-red-50 text-[#e3000f] text-xs font-bold uppercase tracking-widest rounded-full mb-6">
                <span class="relative flex h-2 w-2">
                    <span class="animate-ping absolute inline-flex h-full w-full rounded-full bg-red-400 opacity-75"></span>
                    <span class="relative inline-flex rounded-full h-2 w-2 bg-[#e3000f]"></span>
                </span>
                New Courses Available
            </div>
            <h1 class="text-5xl lg:text-7xl font-[800] text-slate-900 leading-[1.1] mb-8 tracking-tight">
                Unlock Your <span class="text-[#e3000f]">Potential</span> with The Ace India
            </h1>
            ...
            <div class="flex flex-wrap gap-4">
                <a href="{{ route('register') }}" class="px-8 py-4 bg-[#e3000f] text-white font-bold rounded-xl hover:bg-[#cc0000] transition-all transform hover:-translate-y-1 shadow-xl shadow-red-500/30">
                    Explore Courses
                </a>
            ...
            <div class="relative bg-white p-4 rounded-[2rem] shadow-2xl border border-slate-100 overflow-hidden group">
                ...
                <div class="absolute bottom-10 left-10 right-10 p-6 bg-white/90 backdrop-blur-md rounded-2xl border border-white/50 shadow-xl">
                    <div class="flex items-center gap-4">
                        <div class="w-12 h-12 bg-[#e3000f] rounded-xl flex items-center justify-center text-white shadow-lg shadow-red-500/20">
                            <i class="bi bi-play-fill text-2xl"></i>
                        </div>
                        <div>
                            <div class="text-xs font-bold text-[#e3000f] uppercase tracking-widest">Featured Course</div>
    ...
    <div class="mt-32 grid grid-cols-2 md:grid-cols-4 gap-8">
        @foreach([
            ...
            ['label' => 'Active Learners', 'value' => '2,500', 'icon' => 'bi-people', 'color' => 'bg-red-50 text-[#e3000f]'],
    ...
    <div class="mt-40">
        <div class="flex justify-between items-end mb-12">
            <div>
                <h2 class="text-sm font-bold text-[#e3000f] uppercase tracking-[0.2em] mb-3">Popular Programs</h2>
                <h3 class="text-4xl font-extrabold text-slate-900 tracking-tight">Our Most <span class="text-[#e3000f]">Favorite</span> Courses</h3>
            </div>
            <a href="{{ route('courses.index') }}" class="hidden sm:flex items-center gap-2 text-slate-600 font-bold hover:text-[#e3000f] transition-colors">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="group bg-white rounded-3xl border border-slate-100 shadow-sm hover:shadow-xl transition-all overflow-hidden flex flex-col">
                ...
                <div class="p-6 flex-1 flex flex-col">
                    <h4 class="text-xl font-bold text-slate-900 mb-3 group-hover:text-[#e3000f] transition-colors line-clamp-2">Complete Fullstack Web Development Bootcamp</h4>
                    ...
                    <div class="mt-auto flex items-center justify-between pt-6 border-t border-slate-50">
                        ...
                        <div class="text-xl font-black text-[#e3000f]">₹4,999</div>
                    </div>
                </div>
            </div>
            @endfor
