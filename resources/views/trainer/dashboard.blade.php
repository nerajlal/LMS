...
<div class="space-y-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        @php
            $statCards = [
                ['label' => 'Active Courses', 'value' => $stats['courses'], 'icon' => 'bi-journal-bookmark', 'color' => 'bg-[#e3000f]'],
        ...
        <div class="lg:col-span-2">
            <div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
                <div class="p-6 border-b border-slate-100 flex items-center justify-between">
                    ...
                    <a href="{{ route('trainer.courses.index') }}" class="text-xs font-bold text-[#e3000f] uppercase tracking-widest hover:underline">View All</a>
                </div>
        ...
        <div>
            <div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
                ...
                <div class="p-6 space-y-3">
                    <a href="{{ route('trainer.live-classes.index') }}" class="flex items-center justify-center gap-2 w-full py-3 bg-[#e3000f] text-white font-bold rounded-xl hover:bg-[#cc0000] transition-all shadow-lg shadow-red-500/20 text-sm">
